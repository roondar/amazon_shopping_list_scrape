...
// Replace this with your actual secret key you get from the amazon add MFA page 
...
const amz_domain = process.env.AMZ_DOMAIN;
...
(async () => {
    ...
    await page.goto(`https://${amz_domain}/alexaquantum/sp/alexaShoppingList?ref_=list_d_wl_ys_list_1`);
